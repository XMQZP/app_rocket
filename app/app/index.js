...
const MembercentrecStack = createStackNavigator({
	MembercentrecView: {
		getScreen: () => require('./views/MembercentrecView').default
	},
	ReportmanagementView: {
		getScreen: () => require('./views/ReportmanagementView').default
	},
	AgencyCenterView: {
		getScreen: () => require('./views/AgencyCenterView').default
	},
	SecuritycenterView: {
		getScreen: () => require('./views/SecuritycenterView').default
	},
	WebsiteannouncementView: {
		getScreen: () => require('./views/WebsiteannouncementView').default
	},
	StationSMSView: {
		getScreen: () => require('./views/StationSMSView').default
	},
	SystemsettingsView: {
		getScreen: () => require('./views/SystemsettingsView').default
	},
	PersonaloverviewView: {
		getScreen: () => require('./views/PersonaloverviewView').default
	},
	PersonalreportView: {
		getScreen: () => require('./views/PersonalreportView').default
	},
	BankcardmanagementView: {
		getScreen: () => require('./views/BankcardmanagementView').default
	},
	AddbankcardView: {
		getScreen: () => require('./views/AddbankcardView').default
	},
	loginPasswodeView: {
		getScreen: () => require('./views/loginPasswodeView').default
	},
	fundsPasswodeView: {
		getScreen: () => require('./views/fundsPasswodeView').default
	},
	BillchangeView: {
		getScreen: () => require('./views/BillchangeView').default
	},
	BettingrecordView: {
		getScreen: () => require('./views/BettingrecordView').default
	},
	RechargerecordView: {
		getScreen: () => require('./views/RechargerecordView').default
	},
	WithdrawalsrecordView: {
		getScreen: () => require('./views/WithdrawalsrecordView').default
	},
	TrackingrecordView: {
		getScreen: () => require('./views/TrackingrecordView').default
	},
	EventDetailsView: {
		getScreen: () => require('./views/EventDetailsView').default
	}
}, {
	defaultNavigationOptions: defaultHeader,
	cardStyle
...
MembercentrecStack.navigationOptions = ({ navigation }) => {
	let drawerLockMode = 'unlocked';
	if (navigation.state.index > 0) {
		drawerLockMode = 'locked-closed';
	}
...
const LotteryhallStack = createStackNavigator({
	LotteryhallView: {
		getScreen: () => require('./views/LotteryhallView').default
	},
	gameSelectionView: {
		getScreen: () => require('./views/gameSelectionView').default
	},
	BettingrecordView: {
		getScreen: () => require('./views/BettingrecordView').default
	},
	gameView: {
		getScreen: () => require('./views/gameView').default
	},
}, {
	defaultNavigationOptions: defaultHeader,
	cardStyle
...
LotteryhallStack.navigationOptions = ({ navigation }) => {
	let drawerLockMode = 'unlocked';
	if (navigation.state.index > 0) {
		drawerLockMode = 'locked-closed';
	}
