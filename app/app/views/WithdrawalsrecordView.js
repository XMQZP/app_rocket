			...
			>
				...
				<View >
					...
					<View style={[
						...
						<TextInput
							style={[{flex: 6,height: 50,borderStyle:'solid',}]}
					...
					<View style={[
						...
						<Text style={[{fontSize: 20, flex: 1,color:'black',textAlign:'center'}]}>提现时间</Text>
						<Text style={[{fontSize: 20, flex: 1,color:'black',textAlign:'center'}]}>提现金额</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(WithdrawalsrecordView));
