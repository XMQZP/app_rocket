			...
			>
				...
				<View >
					...
					<View style={[
						...
						<Text style={[{fontSize: 20, flex: 1,color:'black',textAlign:'center'}]}>充值时间</Text>
						<Text style={[{fontSize: 20, flex: 1,color:'black',textAlign:'center'}]}>充值金额</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(RechargerecordView));
