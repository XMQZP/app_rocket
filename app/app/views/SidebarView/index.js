			...
			<>
				<View style={[{flexDirection: 'row'}]}>
					<SidebarItem
						...
						left={<CustomIcon name='user-rounded' size={20} color={themes[theme].titleText} />}
						onPress={() => this.sidebarNavigate('RoomsListView')}
						testID='sidebar-chats'
						current={activeItemKey === 'RechargeStack'}
					/>
					<SidebarItem
						text={I18n.t('Withdraw')}
						left={<CustomIcon name='user-plus' size={20} color={themes[theme].titleText} />}
						onPress={() => this.sidebarNavigate('RoomsListView')}
						testID='sidebar-chats'
						current={activeItemKey === 'WithdrawStack'}
					/>
				</View>
				<SidebarItem
					text={I18n.t('Chats')}
				...
				/>
				<SidebarItem
					text={I18n.t('Lottery_hall')}
					left={<CustomIcon name='list' size={20} color={themes[theme].titleText} />}
					onPress={() => this.sidebarNavigate('LotteryhallView')}
					testID='sidebar-Lotteryhall'
					current={activeItemKey === 'LotteryhallStack'}
				/>
				<SidebarItem
					text={I18n.t('Membercentrec')}
					left={<CustomIcon name='Download' size={20} color={themes[theme].titleText} />}
					onPress={() => this.sidebarNavigate('MembercentrecView')}
					testID='sidebar-Membercentrec'
					current={activeItemKey === 'MembercentrecStack'}
				/>
				{isAdmin ? (
					<SidebarItem
