...
class TrackingrecordView extends React.Component {
				...
				<View >
					...
					>
						...
						>
							...
							{gamelist.map((item, index) => this.PickerItem(item))}
						</Picker>
					</View>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(TrackingrecordView));
