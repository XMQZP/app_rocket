...
const list = [
	{
		label: '登录密码',
		value: 'loginPasswodeView'
	}, {
		label: '资金密码',
		value: 'fundsPasswodeView'
	}, {
		label: '银行卡管理',
...
class SecuritycenterView extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(SecuritycenterView));
